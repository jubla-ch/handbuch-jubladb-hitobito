...
Für ``Erziehungsberechtigten`` stehen dir die Seiten :fa:`file` :ref:`Erste Schritte <schritte-link-target>` und :fa:`file` :ref:`Elterninformation <elterninfo-link-target>` zur Verfügung. Die Seite **Erste Schritte** beschreibt die Grundsteine der Datenbank. Die Seite **Elterninformation** sind spezifische Informationen für die ``Erziehungsberechtigten``.
