...
Für ``Erziehungsberechtigen`` stehen dir die Seiten :ref:`Erste Schritte <schritte-link-target>` und :ref:`Elterninformation <elterninfo-link-target>` zur Verfügung. Die Seite :ref:`Erste Schritte <schritte-link-target>` beschreibt die Grundsteine der Datenbank. Die Seite :ref:`Elterninformation <elterninfo-link-target>` sind spezifische Informationen für die ``Erziehungsberechtigten``.
